  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex
      ...
      <Link to='/' className="max-md:flex-1">
        <div className="absolute left-3  top-7 flex items-center gap-0">
          <span><img src={assets.favicon} alt="" className="w-8 h-10" /></span>
          <span><img src={assets.lgo} alt="" className="w-36 h-auto" /></span>
        </div>
      </Link>
